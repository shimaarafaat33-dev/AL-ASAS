        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-right">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              <a
                href={appSettings?.googlePlayUrl || "https://github.com/shimaarafaat33-dev/AL-ASAS/releases/download/v1.0.0/app-release.apk"}
                target="_blank"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
          <div className="academic-card max-w-sm w-full p-6 rounded-3xl border border-amber-500/40 text-center space-y-4 relative">
            ...
            <div className="bg-white p-4 rounded-2xl inline-block mx-auto shadow-inner">
              <img
                src={appSettings?.qrCodeUrl || "https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=https%3A%2F%2Fgithub.com%2Fshimaarafaat33-dev%2FAL-ASAS%2Freleases%2Fdownload%2Fv1.0.0%2Fapp-release.apk&color=070c1b&bgcolor=ffffff"}
                alt="QR Code"
